...
(ТОВ "ЛАЙТ ФІНАНС")`}</p>
				...
				<p>
					ДУМА ВІКТОР ОЛЕКСАНДРОВИЧ, Країна
					громадянства: Україна; Розмір внеску до статутного фонду: 5 100 000,00
					грн; Частка (%):
					100,00%
				</p>
				<br/>
				...
				<p>
					...
					<br/>
					<br/>
					30.03.2020, 265520083222, ГОЛОВНЕ УПРАВЛІННЯ ДПС У М.КИЄВІ, ДПІ У
					СОЛОМ
					{"'"}ЯНСЬКОМУ РАЙОНІ (СОЛОМ{"'"}ЯНСЬКИЙ РАЙОН М.КИЄВА), 43141267,
					21.01.2021, (дані про взяття на облік як платника податків);
					<br/>
					<br/>
					30.03.2020, 10000001775328, ГОЛОВНЕ УПРАВЛІННЯ ДПС У М.КИЄВІ, ДПІ У
					СОЛОМ
					{"'"}ЯНСЬКОМУ РАЙОНІ (СОЛОМ{"'"}ЯНСЬКИЙ РАЙОН М.КИЄВА), 43141267,
					(дані про
